...
describe "boardshortmessages/new" do
  before(:each) do
    assign(:boardshortmessage, stub_model(Boardshortmessage,
      :board_id => "MyString",
  ...
  it "renders new boardshortmessage form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", boardshortmessages_path, "post" do
